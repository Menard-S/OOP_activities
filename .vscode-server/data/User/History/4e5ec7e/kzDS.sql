...
-- Already deleted the 6th student (line 22). Assuming that the student IDs in students table are 1, 2, 3, 4, 5...
...
(25, 'FAIL'); -- ID not in s table, violates CHECK constraints
