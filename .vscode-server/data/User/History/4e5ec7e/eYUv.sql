...
-- Assuming student IDs in your students table are 1, 2, 3, 4, 5 after the DELETE operation.
INSERT INTO research_papers (student_id, grade) VALUES
(1, 'A'),
(1, 'B'),
(2, 'C'),
(2, 'D'),
(2, 'E'), -- This student has more than 1 research paper
(3, 'F'),
(3, NULL), -- This student has an ungraded research paper
(4, 'A'),
(5, 'B'),
(5, 'C'); -- This student has more than 1 research paper
